...
export default function Timesheet() {
  ...
  }, [role, userId, showSummary]);// Add dependencies to refetch when role or userId changes
    ...
    >
      ...
      {showSummary ? (
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-100">
                {role === "Admin" && <th className="text-left p-1 border-b">Consultant</th>}
          ...
          {role === "Admin"  &&     <th className="text-left p-1 border-b">Action</th>}
              </tr>
            </thead>
            <tbody>
