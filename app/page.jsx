 ...
 useEffect(() => {
  ...
  return (
    <div className="min-h-screen p-6 mt-4">
      ...
      {/* Summary Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 p-2 rounded lg:grid-cols-4 gap-3 mt-6">
        <div className="bg-gray-900 text-white p-4 rounded-lg shadow">
          <h2 className="text-base font-semibold">Total Income <svg xmlns="http://www.w3.org/2000/svg"  width="16" height="16" fill="currentColor" className="bi bi-bar-chart-fill" viewBox="0 0 16 16">
  <path d="M1 11a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3zm5-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V2z"></path>
          ...
          <p className="text-2xl font-bold">$ <CountUp duration={4} end={totalIncome}/></p>
        </div>
        <div className="bg-gray-900 text-white p-4 rounded-lg shadow">
          <h2 className="text-base font-semibold">Total Expense
  ...
  <path d="M14 16a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12zM5.904 5.197 10 9.293V6.525a.5.5 0 0 1 1 0V10.5a.5.5 0 0 1-.5.5H6.525a.5.5 0 0 1 0-1h2.768L5.197 5.904a.5.5 0 0 1 .707-.707z"></path>
          ...
          <p className="text-2xl font-bold">$ <CountUp duration={3} end={totalExpense}/></p>
        </div>
        <div className="bg-gray-900 text-white p-4 rounded-lg shadow">
          <h2 className="text-base font-semibold">Monthly Income
          <svg xmlns="http://www.w3.org/2000/svg"  width="16" height="16" fill="#fff" className="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
  <path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1z"></path>
          ...
          <p className="text-2xl font-bold">$ <CountUp duration={5} end={monthlyIncome}/> </p>
        </div>
        <div className="bg-gray-900 text-white p-4 rounded-lg shadow">
          <h2 className="text-base font-semibold">Monthly Expense
  ...
  <path d="M0 14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v12zm4.5-6.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5a.5.5 0 0 1 0-1z"></path>
          ...
          <p className="text-2xl font-bold">$ <CountUp duration={2} end={monthlyExpense}/>  </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
        ...
        <div onClick={()=>router.push('/consultants')} className="bg-white hover:cursor-pointer hover:-translate-y-1 transition-all duration-100 hover:text-gray-900 p-6 rounded-lg shadow text-center">
          <h2 className="text-lg font-semibold">Consultants</h2>
          <p className="text-2xl font-bold">{consultants}</p>
        </div>
        <div onClick={()=>router.push('/projects')} className="bg-white hover:cursor-pointer hover:-translate-y-1 transition-all duration-100 hover:text-gray-900 p-6 rounded-lg shadow text-center">
