...
export default function ContractDetails() {
 ...
 const [formData, setFormData] = useState({
  ...
  consultants: data.consultants?.map(c => c._id || c) || [],
  ...
  adminFee: data.adminFee || 0 // Add this line
});
        setLoading(false);
      } catch (err) {
      ...
      {!isEditing ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div>
  <h3 className="text-sm font-bold text-gray-700 uppercase tracking-wider">Admin Fee</h3>
  <p className="mt-1 text-lg">{contract.adminFee || 0}%</p>
</div>
